...
enum class Symbol(
    ...
    UP_ARROW("^", 9, isBinary = true),
    DOUBLE_LEFT_ARROW("<<", 5, isBinary = true),
    DOUBLE_RIGHT_ARROW(">>", 5, isBinary = true),
    PERCENT("%", 3, isBinary = true, isUnary = true),
    DOUBLE_AMPERSAND("&&", 11, isBinary = true),
    AND("and", 11, isBinary = true),
    DOUBLE_BAR("||", 12, isBinary = true),
    OR("or", 12, isBinary = true),
    DOUBLE_EQUALS("==", 7, isBinary = true),
    BANG_EQUALS("!=", 7, isBinary = true),
    LEFT_ARROW("<", 6, isBinary = true),
    LEFT_ARROW_EQUALS("<=", 6, isBinary = true),
    RIGHT_ARROW(">", 6, isBinary = true),
    RIGHT_ARROW_EQUALS(">=", 6, isBinary = true),
    EQUALS("=", isAssignment = true),
    PLUS_EQUALS("+=", isAssignment = true),
    MINUS_EQUALS("-=", isAssignment = true),
    TIMES_EQUALS("*=", isAssignment = true),
    DIVIDE_EQUALS("/=", isAssignment = true),
    PERCENT_EQUALS("%=", isAssignment = true),
    BITWISE_SHIFT_LEFT_EQUALS("<<="),
    BITWISE_SHIFT_RIGHT_EQUALS(">>="),
    AMPERSAND_EQUALS("&="),
    BAR_EQUALS("|="),
    UP_ARROW_EQUALS("^="),
    DOUBLE_PLUS("++", isUnary = true, isPostfix = true),
    DOUBLE_MINUS("--", isUnary = true, isPostfix = true),
